...
<link href="./assets/css/one-page-checkout.css" type="text/css"
	rel="stylesheet" />
<link href="../style/chooseoption.css" type="text/css"
	rel="stylesheet" />
...
<BODY>
	...
	<div class="phppot-container">
		<div class="page-heading">Menu Options</div>
					...
					<div class="inline-block">
						<div>
							<input class="bank-transfer" type="radio"
								value="Direct bank transfer" name="direct-bank-transfer">Collect on spot and pay
							<input class="bank-transfer" type="radio"
								value="Direct bank transfer" name="direct-bank-transfer">Have delivery made
